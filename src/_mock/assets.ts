...
export const _prices = [
  8, 97.14, 68.71, 85.21, 52.17, 25.18, 43.84, 60.98, 98.42, 53.37, 72.75, 56.61, 64.55, 77.32,
...
export const _descriptions = [
  `Do you need a beach location for a product shoot where the shoot can take place outdoors or indoors? Then we are the right address!`,
