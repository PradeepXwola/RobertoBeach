...
import RestaurentHome from 'src/sections/_home/restaurent';
import EventHome from 'src/sections/_home/events';
import VolleyBallHome from 'src/sections/_home/volleyBall';
