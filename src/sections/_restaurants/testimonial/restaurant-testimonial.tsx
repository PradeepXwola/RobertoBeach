...
import { TestimonialItemContent, TestimonialItemThumbnail } from './restaurant-testimonial-item';
...
export default function RestaurantTestimonial({ testimonials }: Props) {
