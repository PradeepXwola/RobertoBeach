...
export default function EventTeam({ members }: Props) {
          ...
          <Grid xs={12} md={4}>
            <Stack spacing={3} sx={{ textAlign: { xs: 'center', md: 'unset' } }}>
              ...
              <Typography sx={{ color: 'common.white' }}>
                Our team is a dynamic group of dedicated professionals, each bringing their unique expertise
                and passion for creating unforgettable experiences.
              </Typography>
            </Stack>
          </Grid>
